...
<body class="antialiased">
    <div
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            ...
            @else
            <a href=" {{ route('login') }}"
                class="text-md no-underline text-grey-darker hover:text-blue-dark ml-2 px-1">Log in</a>

            @if (Route::has('register'))
            <a href="{{ route('register') }}"
                class="text-md no-underline text-grey-darker hover:text-blue-dark ml-2 px-1">Register</a>
            @endif
            @endauth
        </div>
        @endif
                ...
                <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-8 xxl:col-span-12">
                    <div class="w-full">
                        <h1 class="text-7xl sm:text-8xl lg:text-8xl xl:text-9xl text-white font-bold my-8">
                            ...
                            <p class="text-xl text-white font-semibold ">Lets Hack Moon</p>
                    </div>
                </div>
            </div>
